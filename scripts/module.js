    ...
    SavageSystemManager = class SavageSystemManager extends coreModule.api.SystemManager {
        ...
        async doRegisterDefaultFlags() {
            const GROUP = {
                ...
                powersfav: { id: 'powersfavorite', name: coreModule.api.Utils.i18n('SWADE.QuickAccess')+"-"+coreModule.api.Utils.i18n('SWADE.Pow'), type: 'system' },
                ...
                consumablesfav: { id: 'consumablesfavorite', name: coreModule.api.Utils.i18n('SWADE.QuickAccess')+"-"+coreModule.api.Utils.i18n('SWADE.Consumable.Consumables'), type: 'system' },
                gears: { id: 'gears', name: coreModule.api.Utils.i18n('TYPES.Item.gear'), type: 'system' },
                gearsfav: { id: 'gearsfavorite', name: coreModule.api.Utils.i18n('SWADE.QuickAccess')+"-"+coreModule.api.Utils.i18n('Types.Item.gear'), type: 'system' },
                weapons: { id: 'weapons', name: coreModule.api.Utils.i18n('SWADE.Weapons'), type: 'system' },
                weaponsfav: { id: 'weaponsfavorite', name: coreModule.api.Utils.i18n('SWADE.QuickAccess')+"-"+coreModule.api.Utils.i18n('SWADE.Weapons'), type: 'system' },
                actions: { id: 'actions', name: coreModule.api.Utils.i18n('SWADE.Actions'), type: 'system' },
                actionsfav: { id: 'actionsfavorite', name: coreModule.api.Utils.i18n('SWADE.QuickAccess')+"-"+coreModule.api.Utils.i18n('SWADE.Actions'), type: 'system' },
